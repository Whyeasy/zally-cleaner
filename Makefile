build:
	go build -o bin/zally-cleaner ./cmd/zally-cleaner
...
untag:
	...
	curl --request DELETE --header "Authorization: token ${GITHUB_TOKEN}" "https://api.github.com/repos/whyeasy/zally-cleaner/releases/:release_id/$(TAG)"
